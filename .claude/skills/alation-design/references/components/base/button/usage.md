...
### Conditions
- **Destructive commit** (Destructive named style, `color="error"`) must be paired with a [ConfirmDialog](../composite/dialog/usage.md). The Button is correct — the dialog is the guardrail.
