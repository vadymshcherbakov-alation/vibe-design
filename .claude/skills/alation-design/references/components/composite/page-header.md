...
- You need a modal title bar → use [Dialog](./dialog.md).
...
- [Typography](../foundations/typography.md) — title (`h1`), breadcrumb items (`body2`)
- [Button](../base/button.md) — primary action (contained for creation, outlined for state)
