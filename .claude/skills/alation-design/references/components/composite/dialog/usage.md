...
### Conditions
- When the dialog wraps a destructive action, the confirm Button MUST use the destructive named-style (see [Button](../base/button/usage.md)).
- When the dialog contains a form, wrap fields in a [Form](./form/usage.md) — use `variant="subtitle2"` for labels when the form is inside a Dialog (tighter than page-level `subtitle1`).
...
- [Button](../base/button/usage.md) — Cancel (`color="inherit"`) + Confirm (`variant="contained"` or destructive named-style)
- [TextField](../base/text-field/usage.md) / [Form](./form/usage.md) — form content if applicable
- [Typography](../foundations/typography/usage.md) — `subtitle2` labels inside the body
